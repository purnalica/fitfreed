...
Once immutable GitHub Release `v0.1.21` exists, FitFreed 0.1.21 is the supported public version for Apple Silicon on macOS 15.0 or later and x86-64 Ubuntu Desktop 24.04 and 26.04 LTS, with an explicitly unsigned x86-64 Windows preview.
