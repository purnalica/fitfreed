...
Describe the user or contributor outcome and the problem it solves.

## Traceability

Link the relevant issue, requirement, decision, or roadmap increment.

## Verification

List the behavioral checks executed and any path that could not be verified.

## Impact

Describe documentation, localization, accessibility, privacy, security, migration, installation, update, and compatibility impact where applicable.
...
- [ ] All documented verification commands pass, or failures are reported above.
