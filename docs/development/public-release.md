...
certificate bundle is stored there as a protected secret, while its password is not. App Store Connect notarization
authority is also unavailable to the workflow.
