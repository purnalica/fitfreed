...
- Read [recorded session routes](user/session-routes.md) for local map controls, conditional evidence relationships, exact source paths, privacy, and current limits.
...
- Read the proposed [public macOS 0.1.11 guide](user/public-macos-0.1.11.md) and [public Linux 0.1.11 guide](user/public-linux-0.1.11.md) for the inactive complete-platform expansion boundary.
- Read the inactive [public Windows 0.1.11 guide](user/public-windows-0.1.11.md) for the future-platform documentation contract; it does not announce or assign a Windows release.
...
The [documentation policy](documentation-policy.md) assigns one canonical home to each kind of knowledge. Provider and FitFreed-owned machine-readable contracts live under [data format documentation](data-formats/README.md); current architecture lives under `architecture/`; historical structural decisions live in ADRs. External reports and private research inputs are not project documentation.
