...
- Tracking exploration is a primary adoption journey, not a secondary session decoration. Running, paddling, cycling, hiking, and other route-bearing sports will retain their own meaningful units and recorded signals while sharing the same map-and-time interaction grammar. The ordinary session view will provide enough map area, legible controls, synchronized inspection, section comparison, and exact evidence to investigate a route without switching to an unrelated diagnostics surface.
