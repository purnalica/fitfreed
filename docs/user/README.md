...
The [public macOS 0.1.4 guide](public-macos-0.1.4.md) is the future signed-release download, verification, installation, import, exploration, update, recovery, removal, and support guide. It is conditional and does not announce a binary.

The [public Linux 0.1.4 guide](public-linux-0.1.4.md) is the future Ubuntu x86-64 Debian-package download,
...
The [public Windows 0.1.4 guide](public-windows-0.1.4.md) is the future Windows 11 x86-64 current-user NSIS download,
