...
preflight validates the immutable macOS-plus-Linux predecessor and both independently protected Windows environments.
...
acceptance environment precedes the existing independent publication approval. The workflow remains inactive until
