...
from the canonical catalogs and walks the eager entry closure before emitting artifacts. Reaching the complete
application, complete application stylesheet, or either complete catalog through that closure fails the build.
