...
boundaries. X7-R8.9 and X7-R8.10 now retain machine evidence for reusable local sport correlation, documented provider
normalization, evidence-gated changed-package reuse, and responsive desktop queries during late reconciliation;
compact sport-card geometry and the repeated candidate gate remain open. Reports and personal range
