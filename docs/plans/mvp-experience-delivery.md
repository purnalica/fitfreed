...
Active as of 2026-08-20. D0, P1, E1, E2, P2, all three E3 slices, all seven E4 slices, and all six E5 verticals have complete local and hosted acceptance evidence. E6 cross-feature consistency hardening and release-shaped handoff are active. E5 provides durable session-origin authorship, ordered route composition, one coherent training-period comparison family, question-led, exploration-led, session-led, and blank starts, deliberate evidence refresh through a reviewed current candidate, and exact bidirectional navigation between saved reports and their source session or comparison. Shared preview, privacy review, persistence, deterministic self-contained HTML export, keyboard-focus restoration, and the independent resumable exploration contract remain available throughout. The accepted E5 executable boundary and current E6 baseline are recorded in the [public-release readiness ledger](../testing/public-release-readiness.md); subsequent E6 changes retain their own exact-evidence obligations. The canonical <https://fitfreed.org/> origin has valid apex and `www` DNS, verified `purnalica` ownership, a valid certificate, enforced HTTPS, the intended redirect behavior, and exact English and Spanish hosted-byte acceptance under [ADR 0023](../architecture/decisions/0023-use-fitfreed-org-as-the-public-origin.md) and [ADR 0024](../architecture/decisions/0024-generate-localized-product-pages.md).
