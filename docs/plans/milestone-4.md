...
| M4.6 | Pending | Protected production authority, a version assigned after the immutable macOS release, exact candidate execution, clean Ubuntu 24.04 and 26.04 acceptance, the bounded human verdict, and explicit promotion remain gates. |
