...
| M4.2 | Active | Linux recovery version 2, stable channel version 3, and multiplatform upgrade matrix version 2 are defined. Rust authorization, public build mapping, and atomic predecessor staging exist; predecessor discovery, release verification, and platform adapters are next. |
