...
**Status:** in progress. The closed public release-evidence contract is implemented; candidate preparation, Apple inspection, protected workflow, and hosted acceptance remain.
