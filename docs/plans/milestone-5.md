...
finish the update. All four require locale and library preservation, exact installed version, terminal cleanup,
...
release-shaped offline rollback, fallback, retry, exhaustion, or exact Windows 11 gates.
