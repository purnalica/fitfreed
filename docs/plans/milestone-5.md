...
| Allowed change | The impact classifier, CI workflow, their focused topology tests, automation policy, and this execution record. Product code, package identity, installation behavior, test budgets, and every other platform job may not change. |
