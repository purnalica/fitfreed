...
| Product-owner experience evaluation | Open acceptance gate | The bounded privacy-safe [macOS product-owner experience evaluation](macos-candidate-manual-evaluation.md) covers comprehension, trust, usefulness, navigation, and presentation quality only. Functional, accessibility, installation, update, and recovery correctness remains automated evidence. | Run the short experience review only after the exact candidate's automated gates pass, with no blocking or undisposed serious experience finding. |
