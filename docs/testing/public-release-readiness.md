...
| Hosted Windows candidate, native admission, product acceptance, and publication | In progress for 0.1.19 | Hosted Windows Server engineering passes package construction, installation, update recovery, cold launch, filesystem recovery, and data-performance budgets. The expansion workflow binds setup, installed application, and uninstaller to `NotSigned`, preserves the exact Windows 11 client evidence gap, and requires installation, launch, update authority, data preservation, removal, immutable publication, and remote verification. | Seal and admit the exact 0.1.19 portable distribution. Do not claim exact Windows 11 client, Smart App Control, organizational-policy, or Authenticode compatibility from hosted evidence. |
