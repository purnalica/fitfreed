...
inputs, and applies a closed Tauri overlay that creates updater artifacts without storing endpoint or key values in
Tauri configuration. Atomic channel staging validates stable version 2, signs the exact payload through an injected
