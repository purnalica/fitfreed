...
primitives are not yet the complete Linux recovery path: the version 2 manifest and library pair, transfer handoff,
lifecycle integration, runnable fallback, and packaged failure recovery remain open in M4.2.
