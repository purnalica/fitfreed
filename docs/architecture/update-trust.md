...
installed target package identity. Native restoration, runnable fallback, installation coordination, restart
maintenance, and packaged failure recovery remain open in M4.2.
