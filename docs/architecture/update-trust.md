...
Recovery-package preparation, the Windows recovery manifest and leases, watchdog orchestration, and terminal native
state validation remain later parts of Milestone 5.2; these initial primitives alone do not make Windows updates
recoverable.
