...
specialized transition can enter `confirmed`; the generic transition API cannot claim that state. Watchdog
orchestration, native restoration, terminal validation, receipt-bound cleanup, native Windows execution, and
