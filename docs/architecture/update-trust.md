...
fresh launch nonce, and absolute confirmation deadline. Candidate and watchdog leases, watchdog orchestration, native
restoration, terminal validation, receipt-bound cleanup, native Windows execution, and release-shaped recovery
evidence remain required before Windows recovery is operational.
