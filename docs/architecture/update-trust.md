...
authority and leaves the non-terminal attempt intact. Restart reattachment, explicit native-recovery retry, and the
package-shaped failure campaign remain open in M4.2.
