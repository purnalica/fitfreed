...
- Terminal cleanup may happen only after success; it is not implemented yet. Failure restoration is idempotent and retains evidence needed for actionable, sanitized guidance.
