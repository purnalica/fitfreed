...
preserved executable's validated attempt layout. Process leases, native restoration, runnable fallback, installation
coordination, restart maintenance, and packaged failure recovery remain open in M4.2.
