...
- A separate Ubuntu 24.04 capability job builds an instrumented Debian package with the isolated `fitfreed-e2e`
  package name, `/usr/bin/fitfreed-e2e` executable, and `org.fitfreed.desktop.e2e` application identity. It refuses
