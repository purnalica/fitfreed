...
- Personal-range creation, cancellation, validation, reopening, renaming, exact-timeline boundary adjustment, guarded removal, concise revision-coherent summary, disclosed exact evidence and limitations, reimport review, stale revision recovery, packaged-process restart, accessibility, adaptive layout, and dense-session response budgets. Direct map, signal-lane, structure, and exact-evidence handles, including overlapping and duplicate-name interaction, remain the next R8 increment.
