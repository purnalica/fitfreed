# Polar Flow Planned-Training Mapping Version 1
...
- Planned-training mapping: `polar-planned-training@1`
...
- Persistence: [SQLite schema version 31](../persistence/sqlite-v31.md)
...
`polar-planned-training@1`; a later mapping can enrich the same source evidence without fabricating a source edit.
