...
The provider-neutral [daily activity overview version 2](../insights/daily-activity-overview-v2.md) and [comparison version 1](../insights/daily-activity-comparison-v1.md) are derived from these facts without changing this canonical version. Their requested and selected ranges, gap entries, summaries, changes, daily-detail projection, visual scales, and transport encoding are disposable Insights and presentation concerns rather than canonical fields.
