...
The provider-neutral [daily activity overview version 1](../insights/daily-activity-overview-v1.md) is derived from these facts without changing this canonical version. Its selected range, gap entries, summaries, visual scale, and transport encoding are disposable Insights and presentation concerns rather than canonical fields.
