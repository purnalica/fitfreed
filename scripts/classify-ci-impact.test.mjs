  ...
  assert.deepEqual(
    classifyCiImpact({
      ...
      changedPaths: [
        ...
        "scripts/prepare-public-pages.mjs",
        "scripts/prepare-public-pages.test.mjs",
        "scripts/public-release-remote.mjs",
...
test("wires the fail-closed classifier into every hosted verification lane", () => {
  ...
  assert.match(windowsHostJob ?? "", /npm run verify:windows-authenticode-smoke/);
});
