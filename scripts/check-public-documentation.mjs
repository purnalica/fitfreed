...
const documentContracts = Object.freeze({
  ...
  operations: {
    ...
    evidence: () => [
      ...
      [/GitHub-hosted x86-64 Windows/i, "SignPath build-host boundary"],
      [/FITFREED_SIGNPATH_API_TOKEN/, "SignPath submission authority"],
      [/windows-inner-binaries[\s\S]*windows-nsis-setup/, "SignPath artifact configurations"],
      ...
      [/earlier local-certificate workflow\s+has been removed/i, "removed legacy Windows workflow boundary"],
    ],
  },
  releaseArchitecture: {
