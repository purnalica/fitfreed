...
const supportingDocumentEvidence = Object.freeze({
  ...
  "CODE_SIGNING.md": () => [
    ...
    /no Foundation certificate or active free\s+signing sponsorship/i,
    /ADR 0050[\s\S]*retired SignPath/i,
    /purnalica\/fitfreed/,
    /Windows release contract[\s\S]*setup[\s\S]*installed `fitfreed\.exe`[\s\S]*installed `uninstall\.exe`/i,
