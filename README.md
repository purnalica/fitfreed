...
<ul>
<li>FitFreed 0.1.7 is the supported public Apple Silicon macOS baseline; version 0.1.9 is assigned to the complete macOS-plus-Linux expansion</li>
<li>The Ubuntu Desktop 24.04 and 26.04 x86-64 Debian package and production checksum authority are implemented; public 0.1.9 still requires exact-candidate admission</li>
