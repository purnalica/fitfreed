ALTER TABLE training_discovery_workspace RENAME TO training_discovery_workspace_v1;

CREATE TABLE training_discovery_workspace (
    id INTEGER PRIMARY KEY CHECK (id = 1),
    workspace_version INTEGER NOT NULL CHECK (workspace_version IN (1, 2)),
...
SELECT
    ...
    page_offset, page_limit, view_code, calendar_month, calendar_day,
    selected_session_refs_json, open_session_ref, updated_at_utc
FROM training_discovery_workspace_v1;

DROP TABLE training_discovery_workspace_v1;
